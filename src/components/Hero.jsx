...
const Hero = () => {
  ...
  useEffect(()=>
  {
    init(textRef.current, { showCursor: true, strings: [' Intern at Myanmar Information Technology ', " Junior Web Developer at Next Innovation company(Japan) ", " Mentor ", 'Software Developer ', " Project Lead "] })
  },[]);
      ...
      >
        ...
        <div className="head2">
          <h1 className={`${styles.heroHeadText} text-white`}>
            Hii.. there, I'm <p className='name text-[#915EFF]'>Zaw Htet Naung</p>
          </h1>
          <h3>
        ...
        <a
          href="https://github.com/ZawHtetNaung" target="_blank">
          <AiOutlineGithub />
        </a>
        <a
          href="https://www.linkedin.com/in/zaw-htet-naung-7622451ab/" target="_blank">
          <ImLinkedin />
        </a>
        <a

import {
  ...
  const list = [
    {
      id: "java",
      title: "PHP(Laravel mixed with vue)",
    },
    {
      id: "c++",
      title: "C++",
  ...
  export const javaProject = [
    {
      name: "Shweshops",
      description:
        "Experienced Laravel Developer with 2 years of expertise in high-end projects. Specializing in payment integration, MongoDB, OTP verification, messenger access, and logging. Currently contributing to shweshops.com.",
      tags: [
        {
          name: "laravel",
      ...
      image: crypto,
      source_link: "https://shweshops.com/",
      source_code_link: "https://github.com/ZawHtetNaung/shweshops",
    },
    {
      name: "Gentlmentailor",
      description:
        "Experienced Laravel Developer with 2 years of leading high-end projects, mentoring junior members. Specializing in payment integration and logging. Currently contributing to gentlementailor.shop.",
      tags: [
        {
          name: "laravel",
          color: "blue-text-gradient",
      ...
      image: yml,
      source_link: "https://gentlementailor.shop/",
      source_code_link: "https://github.com/ZawHtetNaung/gentlementailor",
    },
    {
      name: "Tharapa",
      description:
        "Experienced Developer adept in Laravel, Vue, and Node.js, specializing in messenger chatbots. Proficient in maintaining and enhancing campaign chatbots. Eager to contribute expertise to Tharapa.",
      tags: [
        {
          name: "laravel",
          color: "blue-text-gradient",
        ...
        {
          name: "messangerchatbot",
          color: "pink-text-gradient",
        },
      ],
      image: crud,
      source_link: "https://tharapa.ai/",
      source_code_link: "https://github.com/ZawHtetNaung",
    },
    {
      name: "portal.tharapa.ai",
      description:
        "Experienced Developer skilled in Laravel, Vue, and Node.js, specializing in messenger chatbots and logging systems with MongoDB. Proficient in maintaining and enhancing campaign chatbots. Eager to contribute expertise to portal.tharapa.ai's backend.",
      tags: [
        {
          name: "laravel",
          color: "blue-text-gradient",
      ...
      image: dwld,
      source_link: "https://portal.tharapa.ai/",
      source_code_link: "https://github.com/ZawHtetNaung",
    },
    {
      name: "Live Chat Tharapa",
      description:
        "Experienced Developer skilled in Vue.js by using the vuetifjs specializing in messenger chatbots and logging systems with MongoDB. Proficient in maintaining and enhancing campaign chatbots. Eager to contribute expertise to portal.tharapa.ai's backend.",
      tags: [
        {
          name: "vue",
          color: "blue-text-gradient",
